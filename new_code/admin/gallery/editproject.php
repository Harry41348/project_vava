...
$query = "SELECT * FROM `photography_projects` WHERE project_id=" . $_GET["project"];
...
<html>
	...
	<body class="loggedin">
      ...
      <div class="remove__project--container">
        <form action="../uploads/remove_project.php" method="post">
      ...
      <?php
        echo "<h1>Header image</h1>";
        echo "<div class=\"modify__projects--container\">";
          echo "<img class=\"modify__projects--imgs\" src=\"../../imgs/" . $row [2] . "/head.jpg\" alt=\"" . $row [1] . " header image.\">";
          echo "<form action=\"../uploads/changephoto.php\" method=\"POST\" autocomplete=\"off\" enctype=\"multipart/form-data\">";
        ...
        for ($i = 2; $i < $row [7] + 1; $i++) {
          echo "<h1>Image " . $i . "</h1>";
          echo "<div class=\"modify__projects--container\">";
            echo "<img class=\"modify__projects--imgs\" src=\"../../imgs/" . $row [2] . "/img_" . $i . ".jpg\" alt=\"Image " . $i . ".\">";
            echo "<form action=\"../uploads/changephoto.php\" method=\"POST\" autocomplete=\"off\" enctype=\"multipart/form-data\">";
              echo "<input type=\"hidden\" name=\"id\" value=\"" . $row[0] . "\">";
